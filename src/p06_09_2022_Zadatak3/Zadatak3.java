...
U glavnom programu kreirati objekte i testirati sve funkionalnosti
	 ...
	 */
		EmailValidator email = new EmailValidator("sasa@rs.com");
		email.validate().printErrors();
		PasswordValidator pass = new PasswordValidator("@sasaQ1@*");
		pass.validate().printErrors();
		PhoneValidator phone = new PhoneValidator("+12345625");
		phone.validate().printErrors();
