...
Napomena​: Za funkcionalnost koju ne znate da uradite, izostavite njenu implementaciju i smatrajte da je ona implementirana. 
	 */
		RekreativniPlaninar p1 = new RekreativniPlaninar(1000, "Mile Mitic", 15, "Nisavski", 2000);
		RekreativniPlaninar p2 = new RekreativniPlaninar(1001, "Ana Milic", 10, "Nisavski", 1500);
		RekreativniPlaninar p3 = new RekreativniPlaninar(1002, "Nina Tomic", 10, "Vranjanski", 1700);
		
		Alpinista a1 = new Alpinista(2000, "Dule Sanic", 0);
		Alpinista a2 = new Alpinista(2001, "Toma Maric", 5);
		Alpinista a3 = new Alpinista(2002, "Duda Mitic", 10);
		
		Planina pl = new Planina("Suva planina", "Srbija", 1908);
		
		PlaninarskiDom pd = new PlaninarskiDom("Suva", 1980);
		...
		pd.izbaciPlaninara(2001);
		
		pd.stampajPodatke(pl);
